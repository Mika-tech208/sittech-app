...
export default function ParadasPage() {
  ...
  // Aceita vir pré-preenchido via query string (drill-down de Desvios V1:
  // "Ver em Paradas" preserva contexto/janela do desvio) sem mudar o
  // comportamento padrão quando a rota é acessada direto pelo menu. ----
  const FILTROS_INICIAIS = useMemo(() => ({
    dataInicial: searchParams.get("dataInicial") || dataAtrasDias(13),
